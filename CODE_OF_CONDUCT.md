...
We — contributors, maintainers, and users of The Colony — pledge to make
participation in this project a respectful, harassment-free experience
...
discussions, Discord if/when established, conference talks, social
media when representing the project) and also applies when an individual
is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may
be reported to the project maintainers at `jamesbellrepo@outlook.com`.
...
**Consequence:** Private warning, with clarity around the nature of the
...
individuals.
**Consequence:** Permanent ban from any sort of public interaction
